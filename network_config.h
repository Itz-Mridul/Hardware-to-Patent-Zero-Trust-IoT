 ...
 *  Pi IP (Local):    10.238.130.161  ← MQTT broker + Dashboard runs HERE
 *  Mac IP:           10.238.130.167  (Ganache blockchain on Mac)
 *  Mobile IP:        10.238.130.38   (Pixel 9a hotspot/gateway)
 ...
 * ============================================================
 *  ✅ READY TO FLASH — broker on 10.238.130.161:1883 | WiFi: Onki
 * ============================================================
 */
...
#define PI_MQTT_BROKER  "10.238.130.161"   // ← Pi IP on Pixel 9a hotspot (verified 2026-06-19)
...
//  MAC_GANACHE_IP = "10.238.130.167"   port 7545
